...
export default async function OperationsPage() {
  ...
  if (!result.data) {
    return <div className="page"><PageHeader eyebrow="Work Order Intelligence" title="Operations" description="Monitor execution posture, billing progress, receivables, and operational bottlenecks." /><OperationsDashboard error={result.error} /></div>;
  }
